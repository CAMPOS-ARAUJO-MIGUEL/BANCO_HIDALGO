...
public class JfPrincipal extends javax.swing.JFrame {
    ...
    String curp;
    String contraseña;
    private String regexContrasena="^.{8}$";
   // private String regexCurp="^[A-Z]{4}\\d{6}[A-Z]{6}\\d{2}$";
    private String regexCurp="^[A-Z]{4}\\d{6}[A-Z]{6}\\w{2}$";
     ...
     public void asignaValores() {
       curp=jTCurp.getText();
       contraseña=jTContrasena.getText();
       ...
       public boolean validaVacios(String curp, String contraseña){
           if (curp.equals("") || contraseña.equals("")) {
               CUtilitarios.msg_adver("Los campos estan vacios", "Ingresa datos");
            return false;   
           }else{
           return true;
           }
    ...
    return validaCampo(curp, jTCurp, regexCurp, "Ingrese el CURP", "El formato del CRUP es incorrecto")
    &&  validaCampo(contraseña, jTContrasena, regexContrasena, "Ingrese La contraseña", "No exceda los 8 caracteres de la contraseña");
        ...
        public boolean BuscaCuenta(String curp, String contrasena) throws SQLException {
        try {
        ...
        String resultado1 = queryBusca2.buscaCURP(curp); 
            if (resultado1 == null) {
                
                CUtilitarios.msg_adver("La cuenta no existe, genere una nueva en crear cuenta", "Inicio sesión");
               ...
               String curp1=queryBusca3.buscaCURPcontrasena(resultado1,contrasena);
                if (curp.equals(curp1)) {
                    return true;
                    
                }else{
                    
                    CUtilitarios.msg_error("Contraseña incorrecta", "registro contraseña");
                return false;
                }
            }
        ...
        //if (resultado == null) {
            ...
            //return false;
        //} else {
           // CUtilitarios.msg("Inicio de sesión exitosa", "Inicio sesión");
           // return true;
       // }
      ...
      //  e.printStackTrace();  // Esto imprimirá el stack trace para ayudar en el diagnóstico del error.
        CUtilitarios.msg_error("Hubo un problema al intentar iniciar sesión. Por favor intente nuevamente.", "Error de conexión");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese la clave de elector.");
        ...
        jButton2.setText("Procesar Solicitud");
        ...
        jLabel3.setText("Banco Banquito");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel4Layout.createSequentialGroup()
                    .addGap(214, 214, 214)
                    .addComponent(jTCurp, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    //this.dispose(); // Esto cierra la ventana actual, quítalo si no deseas cerrar esta ventana.
        ...
        if (validaCampos()) {
            ...
            try {
                ...
                if (BuscaCuenta(curp, contraseña)) {
    ...
    // Opcional: Cerrar o esconder la ventana actual
            ...
            // Si ocurre un error durante la consulta, lo manejamos aquí
            e.printStackTrace();  // Imprimimos el stack trace para depuración
            CUtilitarios.msg_error("Hubo un problema al intentar iniciar sesión. Por favor, intente nuevamente.", "Error de conexión");
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       // Crear la instancia de JfRegistroCuenta (ventana de creación de cuenta)
    JFRegistro_cuenta registroCuenta=new JFRegistro_cuenta();

    // Hacer visible el JFrame de creación de cuenta
    registroCuenta.setVisible(true);

   // Cerrar o ocultar la ventana actual (si se desea)
   // this.setVisible(false); // Esto oculta la ventana actual
    // Si prefieres cerrar la ventana actual, usa:
