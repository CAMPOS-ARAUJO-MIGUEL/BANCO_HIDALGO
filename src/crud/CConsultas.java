...
//            PreparedStatement pstmt = conn.prepareStatement();
    ...
    public ArrayList<String[]> buscar_civil(String consulta) throws SQLException {
        //1. Abrir la conexion 
        conn = conector.conectar();
        //2. Ejecutar la query(consulta)
        try {
    ...
    public ArrayList<String[]> buscar_direccion(String consulta) throws SQLException {
        //1. Abrir la conexion 
        conn = conector.conectar();
        //2. Ejecutar la query(consulta)
        try {
    ...
    public ArrayList<String[]> buscar_nacionalidad(String consulta) throws SQLException {
        //1. Abrir la conexion 
        conn = conector.conectar();
        //2. Ejecutar la query(consulta)
        try {
